...
def get_weights_fullPZ():
    ...
    list_weights = homogenise_nz.get_weights_fullPZ(list_snr_bins_cats,z_values=z_values,target_nz_index=0,label=label,plots=True,sigma_regularisation = float(config['sigma_regularisation']))
